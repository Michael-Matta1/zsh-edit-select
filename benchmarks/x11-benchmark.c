/*
 * X11 Clipboard Performance Benchmark - Production Ready
...
static void print_comparison(benchmark_result *xclip_res, benchmark_result *daemon_res) {
...
int main(int argc, char *argv[]) {
    ...
    printf("X11 Clipboard Performance Benchmark\n");
    printf("====================================\n\n");
    ...
    benchmark_result xclip_small = benchmark_external_copy(small_text, small_len, 100, "xclip");
    ...
    benchmark_result xclip_medium = benchmark_external_copy(medium_text, 500, 50, "xclip");
    ...
    benchmark_result xclip_large = benchmark_external_copy(large_text, 5000, 25, "xclip");
    ...
    benchmark_result xclip_vlarge = benchmark_external_copy(vlarge_text, 50000, 10, "xclip");
    ...
    benchmark_result xclip_rapid = benchmark_external_copy(rapid_text, strlen(rapid_text), 200, "xclip");
    ...
    double avg_xclip = (xclip_small.avg_time + xclip_medium.avg_time + xclip_large.avg_time +
                        xclip_vlarge.avg_time + xclip_rapid.avg_time) / 5.0;
    ...
    double overall_improvement = ((avg_xclip - avg_daemon) / avg_xclip) * 100;
